...
| [kubeflow-gcp-vertex](kubeflow-gcp-vertex/) | The same KFP pipeline on managed infrastructure — artifacts in GCS, metrics in ML Metadata, CI/CD submits via GitLab with Workload Identity Federation (no service account keys) | KFP, Vertex AI, GCP, GitLab CI, WIF, uv, scikit-learn |
