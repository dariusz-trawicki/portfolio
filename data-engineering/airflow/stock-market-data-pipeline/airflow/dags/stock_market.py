...
# -------- 02 version load_to_dw (OK) ---------

#     @task
#     def load_to_dw_task(file_key: str = ''):
#         aql.load_file(
#             input_file=File(
...
#     stored = store_prices
#     formatted = format_prices
#     csv_path = get_formatted_csv
#     load = load_to_dw_task(file_key=csv_path.output)

#     url >> prices >> stored >> formatted >> csv_path >> load
